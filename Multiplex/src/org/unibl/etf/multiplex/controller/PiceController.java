 ...
 * @author Ognjen
 */
public class PiceController implements Initializable {
    ...
    public PiceController(ObservableList listaDodatihArtikalaOBS, RacunOO racun) {
        this.listaDodatihArtikalaOBS = listaDodatihArtikalaOBS;
        this.racun = racun;
    }
    
    public void update() {
        ArrayList<ArtikalOO> temp = ArtikalAdapter.preuzmiPoTipu("Pice");
        ...
        listaDodatihArtikala.setCellFactory(lv -> new ListCell<StavkaOO>() {
            ...
            public void updateItem(StavkaOO item, boolean empty) {
                ...
                if (empty) {
                    ...
                    //fxmlPrikaz.prefWidthProperty().subtract(20);
                    setGraphic(fxmlPrikaz);
                }
            }
        });

        ukupnoArtikli.addAll(ArtikalAdapter.preuzmiPoTipu("Pice"));
